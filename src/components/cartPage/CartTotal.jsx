...
const CartTotal = ({button,width}) => {
    ...
    const {delivery_fee,currency,subTotal} = useShopContext();

    return (
            <div className={`p-5 w-full sm:w-1/2 ${width && `md:w-1/3`} rounded-xl bg-red-300 sm:drop-shadow-sm sm:drop-shadow-black flex flex-col justify-center items-start gap-5`}>

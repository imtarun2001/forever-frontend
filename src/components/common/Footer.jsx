        ...
        <div>
            ...
            <div className='w-full mt-10 mb-1 flex flex-col sm:flex-row justify-between items-start sm:gap-12'>
                ...
                <div className="w-full sm:w-1/2 flex flex-col justify-center items-start gap-5 mb-5 sm:mb-0">
                    ...
                    <p className="w-full md:w-2/3 text-gray-600 text-xs sm:text-sm text-justify text-wrap">Forever is where timeless design meets modern living. From curated collections to everyday essentials, we bring you pieces that are made to last — inspired by beauty, crafted for life.</p>
                </div>

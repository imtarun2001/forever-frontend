  ...
  return (
    <div className="h-screen w-full flex justify-center items-center absolute bg-black">
      <div className='h-1/2 w-2/3 bg-black flex flex-col justify-center items-center gap-3'>
        ...
        <motion.p initial={{ fontSize: screenWidth < 350 ? '5rem' : '7rem' }} whileInView={{ fontSize: screenWidth < 350 ? '2rem' : '4rem' }} transition={transition} className="kaushan-script tracking-widest text-white z-10">FOREVER</motion.p>

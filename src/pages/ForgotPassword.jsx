    ...
    return (
        <div className="w-full h-screen flex justify-center items-center relative">
            ...
            <div className='flex flex-col justify-center items-center gap-5 rounded border sm:border-0 sm:shadow shadow-black p-5 sm:p-10'>
                ...
                <button className="bg-black font-semibold flex justify-center items-center w-full py-2 text-white hover:bg-gray-600 rounded-lg cursor-pointer" disabled={loading ? true : false} onClick={forgotPasswordLinkToEmail}>{loading ? `Verifying...` : `Verify`}</button>
            </div>
        </div>
    )
}
